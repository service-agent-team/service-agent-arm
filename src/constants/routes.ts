export const ROUTES = {
  ...
  letsTripGroupTourCreate: '/lets-trip/group-tour/create',
  letsTripGroupTourEdit: '/lets-trip/tour/group-edit/:id',
  letsTripGroupTourView: '/lets-trip/tour/group-view/:id',
  letsTripIndividualTour: '/lets-trip/individual-tour',
  letsTripIndividualTourCreate: '/lets-trip/individual-tour/create',
  letsTripIndividualTourEdit: '/lets-trip/tour/individual-edit/:id',
  letsTripIndividualTourView: '/lets-trip/tour/individual-view/:id',
