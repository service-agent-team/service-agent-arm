...
export const utils = () => {
  ...
  const getColumnSearchProps = (
    dataIndex: DataIndex,
  ): ColumnType<ILetsTripIndividualTourByCountryId> => ({
  ...
  const columns: ColumnsType<ILetsTripIndividualTourByCountryId> = [
    {
      title: 'Id',
      dataIndex: 'id',
      key: 'id',
            ...
            {record.deleted ? (
              ...
              <>
                <Button
                  ...
                  onClick={() =>
                    navigate(
                      `${ROUTES.letsTripTour}/by-country/${countryId}/${tourType}/edit/${record.id}`,
                    )
                  }
                >
                  <EditOutlined />
